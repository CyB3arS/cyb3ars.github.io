...
![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319203958.png)
...
![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319204843.png)
...
![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319205203.png)
...
![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Captura de pantalla 2025-03-19 210903.png)

La web a la que nos lleva es la siguiente:

![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319205453.png)
...
![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319205924.png)

Al probar con la SQL Injection efectivamente no esta bien sanitizada y logramos obtener acceso:

![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319210022.png)
...
![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319211755.png)
...
![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319212410.png)
...
![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319212921.png)

Por lo cual procedemos ha realizar la explotación y elevación de privilegios:

![](/assets/images/{{page.platform}}/{{page.difficult}}/{{page.machine}}/Pasted image 20250319213401.png)
